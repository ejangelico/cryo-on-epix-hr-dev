...
#################################################################################################################
#
#  ASIC CRYO prototype v0.2
#
#################################################################################################################
class CryoAsic0p2(pr.Device):
    def __init__(self, **kwargs):
        """Create the cryo ASIC 0P2 device"""
        super().__init__(description='EpixHrAdc Asic Configuration', **kwargs)
...
class CryoAsic0p2b(pr.Device):
    def __init__(self, **kwargs):
        ...
        #self.add((pr.RemoteVariable(name='Register02',              description='Config16', offset=(CMD_TYPE_1 + 0x02)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register03',              description='Config16', offset=(CMD_TYPE_1 + 0x03)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register04',              description='Config16', offset=(CMD_TYPE_1 + 0x04)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register05',              description='Config16', offset=(CMD_TYPE_1 + 0x05)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register06',              description='Config16', offset=(CMD_TYPE_1 + 0x06)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register07',              description='Config16', offset=(CMD_TYPE_1 + 0x07)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register08',              description='Config16', offset=(CMD_TYPE_1 + 0x08)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register09',              description='Config16', offset=(CMD_TYPE_1 + 0x09)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register10',              description='Config16', offset=(CMD_TYPE_1 + 0x0A)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register11',              description='Config16', offset=(CMD_TYPE_1 + 0x0B)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register12',              description='Config16', offset=(CMD_TYPE_1 + 0x0C)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register13',              description='Config16', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        self.add((pr.RemoteVariable(name='Register14',              description='Config16', offset=(CMD_TYPE_1 + 0x0E)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register15',              description='Config16', offset=(CMD_TYPE_1 + 0x0F)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
        #self.add((pr.RemoteVariable(name='Register16',              description='Config16', offset=(CMD_TYPE_1 + 0x10)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode='RW')))
...
#################################################################################################################
#
#  ASIC CRYO prototype v0.3 (DUNE variant)
#
#################################################################################################################
class CryoAsic0p3(pr.Device):
    def __init__(self, **kwargs):
        """Create the cryo ASIC 0P3 device, DUNE variant"""
        super().__init__(description='EpixHrAdc Asic Configuration', **kwargs)
        ...
        # CMD = 1, Addr = 5
        self.add((
            pr.RemoteVariable(name='bleak_boost',   description='Config5', offset=(CMD_TYPE_1 + 0x05)*addrSize, bitSize=2,  bitOffset=0,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='TPS_DAC',       description='Config5', offset=(CMD_TYPE_1 + 0x05)*addrSize, bitSize=6,  bitOffset=2,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='TPS_GR',        description='Config5', offset=(CMD_TYPE_1 + 0x05)*addrSize, bitSize=4,  bitOffset=8,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='TPSMux',        description='Config5', offset=(CMD_TYPE_1 + 0x05)*addrSize, bitSize=4,  bitOffset=12, base=pr.UInt, mode=CMD_1_MODE)))
        # CMD = 1, Addr = 6
        ...
        self.add((
            ...
            pr.RemoteVariable(name='DM2en',                     description='Config8', offset=(CMD_TYPE_1 + 0x08)*addrSize, bitSize=1,  bitOffset=9,  base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='Pulser_Monost',             description='Config8', offset=(CMD_TYPE_1 + 0x08)*addrSize, bitSize=3,  bitOffset=10, base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='Bias_LVDS_Tx_25m_driver',   description='Config8', offset=(CMD_TYPE_1 + 0x08)*addrSize, bitSize=1,  bitOffset=13, base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='cs_LVDS_Tx',                description='Config8', offset=(CMD_TYPE_1 + 0x08)*addrSize, bitSize=2,  bitOffset=14, base=pr.UInt, mode=CMD_1_MODE)))
        ...
        self.add((
            pr.RemoteVariable(name='ROsLVDS_bit',    description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=1,  bitOffset=0,  base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='SACIsLVDS_bit',  description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=1,  bitOffset=1,  base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='d_emph',         description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=3,  bitOffset=2,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='pre_emph_en',    description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=1,  bitOffset=5,  base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='PLL_RO_Itune_b3',description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=1,  bitOffset=6,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='PLL_RO_KVCO_b3', description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=1,  bitOffset=7,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='DM1sel',         description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=4,  bitOffset=8,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='DM2sel',         description='Config13', offset=(CMD_TYPE_1 + 0x0D)*addrSize, bitSize=4,  bitOffset=12, base=pr.UInt, mode=CMD_1_MODE)))
...
#        self.add((pr.RemoteVariable(name='Register16',              description='Config16', offset=(CMD_TYPE_1 + 0x10)*addrSize, bitSize=16,  bitOffset=0,  base=pr.UInt, mode=CMD_1_MODE)))
        ...
        self.add((
            ...
            pr.RemoteVariable(name='Ana_Mon_Cal',            description='Config19', offset=(CMD_TYPE_1 + 0x13)*addrSize, bitSize=1,  bitOffset=9,  base=pr.Bool, mode=CMD_1_MODE),
            pr.RemoteVariable(name='ADC_B3B2',               description='Config19', offset=(CMD_TYPE_1 + 0x13)*addrSize, bitSize=2,  bitOffset=10, base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='eFuse_ADDR',             description='Config19', offset=(CMD_TYPE_1 + 0x13)*addrSize, bitSize=4,  bitOffset=12, base=pr.UInt, mode=CMD_1_MODE)))

        # CMD = 1, Addr = 20
        self.add((pr.RemoteVariable(name='eFuse_Q',   description='Config20',  offset=(CMD_TYPE_1 + 0x14)*addrSize, bitSize=16,  bitOffset=0, base=pr.UInt, mode=CMD_1_MODE)))

        # CMD = 1, Addr = 21
        self.add((
            pr.RemoteVariable(name='LDO1V_VTBias_B',  description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=2,  bitOffset=0,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='LDO1V_VTBias_T',  description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=4,  bitOffset=2,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='LDO1V_VTBias_Br', description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=2,  bitOffset=6,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='LDO1V_VTBias_Tr', description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=4,  bitOffset=8,  base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='Rate_mode_b',     description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=3,  bitOffset=12, base=pr.UInt, mode=CMD_1_MODE),
            pr.RemoteVariable(name='PLL_div_sel',     description='Config21', offset=(CMD_TYPE_1 + 0x15)*addrSize, bitSize=1,  bitOffset=15, base=pr.UInt, mode=CMD_1_MODE)))
